...
const semestres = {
  "1° Semestre": ["calculo1", "algebra", "geometriaAnalitica", "antropologia"],
  "2° Semestre": ["calculo2", "programacion", "etica", "ff1"],
  "3° Semestre": ["calculo3", "teoriaNumeros", "metodosED", "estrategias1", "ff2"],
  "4° Semestre": ["analisis", "estructuras1", "practicaInicial", "tallerAdolescente", "diversidad"],
  "5° Semestre": ["didacticaCalculo", "didacticaSistemas", "geometriaEuclidiana", "estadistica1", "ff3"],
  "6° Semestre": ["geometria3D", "didacticaEstadistica", "practicaComunitaria", "psicologia", "filosofia", "ingles1"],
  "7° Semestre": ["optativo1", "didacticaGeometria", "estadistica2", "curriculo", "politicas", "estrategias2", "ingles2"],
  "8° Semestre": ["tecnologia", "probabilidad", "intermedia", "evaluacion", "ingles3"],
  "9° Semestre": ["optativo2", "historia", "investigacion", "titulo", "identidad", "ingles4"],
  "10° Semestre": ["final"]
};
...
function crearMalla() {
  for (const [semestre, ids] of Object.entries(semestres)) {
    ...
    contenedorSemestre.innerHTML = `<h2>${semestre}</h2>`;
    ...
    contenedorSemestre.appendChild(grid);
